...
if __name__ == '__main__':
	...
	manifest_file = "/Users/vishadnehal/Desktop/EE542/Lab10/vishad/data/gdc_manifest.2018-08-20.txt"
	df = pd.read_csv(manifest_file,sep='\t')
	total = df.shape[0]
	
	# The directory that holds the data. Modify this when use.
	dirname = "/Users/vishadnehal/Desktop/EE542/Lab10/vishad/data/live_miRNA"
	check(dirname,total)
